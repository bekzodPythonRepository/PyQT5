...
bbox.addWidget(lbl3)
box.setLayout(bbox)
#Создаем еще один контейнер помещаем в него две первые надписи группу и кнопку и вставляем в окно
